...
class FileConfig:
    ...
    def __init__(self, cf: ModelConfig):
        ...
        '''
        if cf.model[:5] == 'REHGL':
            f_prefix = f'a{cf.alpha}_{cf.fgh_th}_{cf.fgp_th}'
        self.res_file = f'results/{cf.dataset}/{cf.model}/{cf.exp_name}/{cf.model}_{f_prefix}.txt'
        # self.res_file = f'results/{cf.dataset}/{cf.model}/para/{f_prefix}.txt'
